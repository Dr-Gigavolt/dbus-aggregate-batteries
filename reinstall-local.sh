...
grep -qxF "bash /data/apps/dbus-aggregate-batteries/reinstall-local.sh" /data/rc.local || echo "bash /data/apps/dbus-aggregate-batteriesdbus-aggregate-batteries/reinstall-local.sh" >> /data/rc.local
